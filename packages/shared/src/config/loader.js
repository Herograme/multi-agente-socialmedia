...
import { DEFAULT_SERVER, DEFAULT_SOURCES, DEFAULT_QUALITY, DEFAULT_LLM_MODELS, DEFAULT_IMAGE_STYLES, } from './defaults';
...
function loadServerConfig() {
    const nodeEnv = (process.env.NODE_ENV || DEFAULT_SERVER.nodeEnv);
    ...
    return {
        ...
        nodeEnv,
        logLevel: (process.env.LOG_LEVEL || DEFAULT_SERVER.logLevel),
    };
}
 ...
 */
export function getProviderSummary(config) {
    const lines = [
